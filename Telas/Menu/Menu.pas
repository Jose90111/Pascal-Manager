...
if Application.MessageBox('Você deseja DELETAR esse cadastro?','Confirmação',MB_ICONWARNING+MB_YESNO)= mrYES then
    begin
      ...
      Application.MessageBox('Cadastro Deletado!','Confirma��o');
    end;
end;
...
<<<<<<< HEAD
  ...
  if DM.code.RecordCount=0 then showmessage('N�o existem itens cadastrados!');
...
<<<<<<< HEAD
    begin// Se encontrar n�o encontrar categoria com o mesmo nome, confirmar se o usu�rio deseja criar uma nova
      ...
      replace_cat := Application.MessageBox('Categoria n�o encontrada',' Deseja criar uma nova categoria com este nome?',MB_YESNO) = 6;
